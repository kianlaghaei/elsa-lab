...
- All four completed experiments were verified against Elsa 3.8.4 and .NET 10 (`net10.0`). Re-run relevant experiments before relying on these findings after an Elsa upgrade.
...
| Loops and revision cycles | Not yet tested (ELSA-05) |
